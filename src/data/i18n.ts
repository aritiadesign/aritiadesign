...
export const i18n: Record<string, { fr: string; en: string }> = {
  ...
  "services.pack.0.label":  { fr: "COLLECTION SIGNATURE<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>SUR DEVIS", en: "SIGNATURE COLLECTION<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>ON REQUEST" },
  ...
  "services.pack.2.label":  { fr: "DÉCOR & SCÉNOGRAPHIE<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>SUR DEVIS", en: "DECOR & SET DESIGN<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>ON REQUEST" },
  ...
  "services.pack.3.label":  { fr: "DESIGN FLORAL<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>SUR DEVIS", en: "FLORAL DESIGN<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>ON REQUEST" },
  ...
  "services.pack.4.label":  { fr: "PAPETERIE FINE<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>SUR DEVIS", en: "FINE STATIONERY<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>ON REQUEST" },
  ...
  "investment.tier.0.b0": { fr: "Direction artistique globale : planches d'inspiration<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>palette de couleurs<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>palette de matières<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>charte typographique<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>palette florale, harmonisant papeterie, décor et floral", en: "Holistic creative direction: inspiration boards<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>colour palette<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>material palette<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>typography guidelines<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>floral palette, harmonising stationery, decor and floral" },
  "investment.tier.0.b1": { fr: "Papeterie essentielle : faire-part<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>menus<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>plan de table<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>monogramme classique", en: "Essential stationery: invitations<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>menus<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>seating chart<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>classic monogram" },
  "investment.tier.0.b2": { fr: "Décor & scénographie : croquis et/ou plan 2D de l'espace principal<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>sélection du mobilier et des objets décoratifs", en: "Decor & set design: sketches and/or 2D plan of the main space<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>selection of furniture and decorative objects" },
  "investment.tier.0.b3": { fr: "Floral intimiste : bouquet de la mariée<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>boutonnières<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>5 centres de table<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>arche de cérémonie minimaliste", en: "Intimate florals: bridal bouquet<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>boutonnieres<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>5 table centrepieces<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>minimalist ceremony arch" },
  "investment.tier.0.b4": { fr: "Coordination des prestataires sourcés", en: "Coordination of sourced suppliers" },
  "investment.tier.0.b5": { fr: "3 réunions de travail et 1 visite du lieu de réception", en: "3 working meetings and 1 venue visit" },
  "investment.tier.0.b6": { fr: "Présence le jour J (10 heures) avec installation et démontage J+1", en: "On-site presence on the day (10 hours) with set-up and dismantling on D+1" },
  "investment.tier.0.b7": { fr: "Livrable : <span class=\"hidden md:inline\">carnet d'atmosphère </span>PDF<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>croquis<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>plans 2D<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>BAT", en: "Deliverable: <span class=\"hidden md:inline\">atmosphere </span>PDF<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>sketches<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>2D plans<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>print proofs" },
  ...
  "investment.tier.1.b0": { fr: "Direction artistique commune : planches d'inspiration<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>charte typographique<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>palette de couleurs<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>palette de matières, harmonisant papeterie et décor", en: "Shared creative direction: inspiration boards<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>typography guidelines<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>colour palette<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>material palette, harmonising stationery and decor" },
  "investment.tier.1.b1": { fr: "Papeterie essentielle : faire-part<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>menus<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>plan de table<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>monogramme classique", en: "Essential stationery: invitations<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>menus<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>seating chart<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>classic monogram" },
  "investment.tier.1.b2": { fr: "Décor & scénographie : croquis et/ou plan 2D de l'espace principal<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>sélection du mobilier et des objets décoratifs", en: "Decor & set design: sketches and/or 2D plan of the main space<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>selection of furniture and decorative objects" },
  "investment.tier.1.b3": { fr: "Coordination des prestataires", en: "Supplier coordination" },
  "investment.tier.1.b4": { fr: "2 réunions de travail et 1 visite du lieu de réception", en: "2 working meetings and 1 venue visit" },
  "investment.tier.1.b5": { fr: "Installation le jour J et démontage J+1", en: "Set-up on the day and dismantling on D+1" },
  "investment.tier.1.b6": { fr: "Livrable : <span class=\"hidden md:inline\">carnet </span>PDF<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>croquis<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>plans 2D<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>inventaire", en: "Deliverable: PDF<span class=\"hidden md:inline\"> booklet</span><span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>sketches<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>2D plans<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>inventory" },
  ...
  "investment.tier.2.b5": { fr: "Croquis et/ou plan 2D de l'espace principal", en: "Sketches and/or 2D plan of the main space" },
  ...
  "investment.tier.2.b8": { fr: "Livrable : <span class=\"hidden md:inline\">carnet d'atmosphère </span>PDF<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>Liste de prestataires", en: "Deliverable: <span class=\"hidden md:inline\">atmosphere </span>PDF<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>supplier list" },
  ...
  "investment.alacarte.0.b5": { fr: "Impression<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>façonnage<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>livraison", en: "Printing<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>finishing<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>delivery" },
  "investment.alacarte.0.b6": { fr: "Livrable : BAT et fichiers d'impression", en: "Deliverable: print proofs and print files" },
  ...
  "investment.alacarte.2.b2": { fr: "Croquis et/ou plan 2D de l'espace principal", en: "Sketches and/or 2D plan of the main space" },
  ...
  "investment.alacarte.2.b5": { fr: "2 réunions de travail et 1 visite du lieu de réception", en: "2 working meetings and 1 venue visit" },
  "investment.alacarte.2.b6": { fr: "Installation le jour J et démontage J+1", en: "Set-up on the day and dismantling on D+1" },
  "investment.alacarte.2.b7": { fr: "Livrable : <span class=\"hidden md:inline\">carnet </span>PDF<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>croquis<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>plans 2D<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>inventaire", en: "Deliverable: PDF<span class=\"hidden md:inline\"> booklet</span><span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>sketches<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>2D plans<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-medium align-middle mx-1.5 opacity-70\" aria-hidden=\"true\">+</span>inventory" },
