...
export const i18n: Record<string, { fr: string; en: string }> = {
  ...
  "home.method.p": {
    fr: "De la première inspiration au jour J, je vous accompagne avec sensibilité et exigence dans la création d'un univers qui vous ressemble. Mon approche est sur-mesure, pensée pour faire naître la beauté et l'émotion.",
