...
export const i18n: Record<string, { fr: string; en: string }> = {
  ...
  "contact.p": {
    fr: "Votre projet mérite une attention toute particulière, un regard sensible, et une mise en scène à la hauteur de vos émotions. Nous avons hâte de découvrir votre histoire et de façonner un univers qui vous ressemble. Complétez le formulaire ci-dessous pour planifier notre premier échange.",
    en: "Your project deserves particular attention, a sensitive eye and staging worthy of your emotions. We can't wait to discover your story and shape a vision that reflects you. Fill in the form below to plan our first conversation."
  },
