...
export const i18n: Record<string, { fr: string; en: string }> = {
  ...
  "services.faq.2.a": {
    fr: "Les délais idéaux varient selon la formule choisie et l'ampleur du projet :<br /><br />— Pack L'Exception : 10 à 12 mois en amont (univers complet, sourcing des prestataires, coordination de la production).<br /><br />— Pack Atmosphère : 7 à 9 mois sont généralement suffisants.<br /><br />— Direction Artistique seule : à partir de 4 mois.<br /><br />— Design Floral : à partir de 4 mois.<br /><br />— Scénographie & Décors : 6 à 7 mois (conception sur-mesure, sourcing et fabrication).<br /><br />Pour les événements d'envergure (scénographie complexe, grande capacité), nous recommandons d'anticiper davantage. Nous restons toutefois flexibles sur des délais plus courts selon nos disponibilités du moment.",
    en: "Ideal timeframes vary depending on the chosen package and the scale of the project:<br /><br />— The Exception Package: 10 to 12 months in advance (full creative direction, supplier sourcing, production coordination).<br /><br />— Atmosphere Package: 7 to 9 months is generally sufficient.<br /><br />— Art Direction only: from 4 months.<br /><br />— Floral Design: from 4 months.<br /><br />— Set Design & Decor: 6 to 7 months (bespoke design, sourcing and fabrication).<br /><br />For larger-scale events (complex set design, high guest count), we recommend planning further ahead. We remain flexible on shorter timelines depending on our current availability."
  },
  "services.faq.3.q": {
  ...
  "contact.opt.service.2": { fr: "Direction Artistique Seule",           en: "Art Direction Only" },
  ...
  "investment.disclaimer": {
    fr: "Les tarifs affichés reflètent notre <span class=\"font-medium not-italic text-[var(--color-ink)]\">gamme</span> <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">ESSENTIEL</span>, imaginée pour les célébrations intimistes (≤ <span class=\"italic-num\">50</span> invités). Les <span class=\"font-medium not-italic text-[var(--color-ink)]\">gammes supérieures</span>, <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">SIGNATURE</span> et <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">PRESTIGE</span>, sont détaillées dans notre <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">Guide des Services 2026</span>. Chaque projet fait l'objet d'un <span class=\"font-medium not-italic text-[var(--color-ink)]\">devis personnalisé</span> selon l'ampleur de votre événement,<span class=\"hidden md:inline\"><br /></span> votre nombre d'invités et la complexité logistique.",
    en: "The rates shown reflect our <span class=\"font-medium not-italic text-[var(--color-ink)]\">ESSENTIEL range</span>, designed for intimate celebrations (≤ <span class=\"italic-num\">50</span> guests). The <span class=\"font-medium not-italic text-[var(--color-ink)]\">higher ranges</span>, <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">SIGNATURE</span> and <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">PRESTIGE</span>, are detailed in our <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">2026 Services Guide</span>. Each project receives a <span class=\"font-medium not-italic text-[var(--color-ink)]\">personalised quote</span> based on the scale of your event,<span class=\"hidden md:inline\"><br /></span> your guest count and the logistical complexity."
  },
