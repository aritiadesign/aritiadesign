...
export const i18n: Record<string, { fr: string; en: string }> = {
  ...
  "services.tab.0": { fr: "✦ L'EXCEPTION DESIGN INTÉGRAL ✦", en: "✦ THE EXCEPTION FULL DESIGN ✦" },
  ...
  "services.0.body": {
    fr: "<p>Ici, votre célébration est pensé comme une œuvre complète : De l'identité visuelle à la scénographie, de l'art floral à la papeterie fine, chaque détail est orchestré pour créer un univers cohérent et d'une rare élégance.</p><p>En tant que directrice de création, je garantis l'harmonie absolue entre le décor, les fleurs et l'identité graphique.</p><p>Cette approche globale vous offre une expérience fluide et une sérénité totale, pour un évènement d'exception, rigoureusement à votre image.</p>",
    en: "<p>Here, your celebration is conceived as a complete work: from visual identity to set design, from floral art to fine stationery, every detail is orchestrated to create a coherent world of rare elegance.</p><p>As creative director, I guarantee absolute harmony between decor, flowers and graphic identity.</p><p>This all-encompassing approach offers you a seamless experience and total peace of mind, for an exceptional event, rigorously in your image.</p>"
  },
  ...
  "services.1.body": {
    fr: "<p>Avec cette prestation, nous créons l'univers visuel complet de votre mariage, du moodboard initial à la mise en scène finale. Elle comprend la définition du concept esthétique, la mise en ambiance des espaces et la coordination des prestataires (mobilier, éclairage, accessoires…) pour un rendu tangible, élégant et cohérent.</p><p>Vous bénéficiez ainsi d'une direction artistique concrète sur le lieu, d'une harmonie visuelle parfaite et d'une prise en charge complète, garantissant un mariage raffiné et maîtrisé jusque dans les moindres détails.</p>",
    en: "<p>With this offering, we craft the full visual world of your wedding, from the initial moodboard to the final staging. It includes defining the aesthetic concept, setting the mood across each space and coordinating suppliers (furniture, lighting, accessories…) for a tangible, elegant and coherent result.</p><p>You benefit from concrete artistic direction on site, perfect visual harmony and complete handling, ensuring a refined wedding mastered down to the smallest detail.</p>"
  },
  ...
  "services.2.body": {
    fr: "<p>Nous concevons des compositions florales sur-mesure pour sublimer chaque instant de vos mariages et évènements, des pièces délicates aux installations sculpturales d'envergure.</p><p>Pensée en parfaite harmonie avec votre identité visuelle, chaque création apporte élégance et authenticité pour placer le végétal au cœur de l'expérience émotionnelle de votre réception.</p><p>C'est une signature raffinée, jouant sur l'équilibre des couleurs et des textures, pour offrir à votre réception une dimension visuelle inoubliable.</p>",
    en: "<p>We design bespoke floral compositions to elevate every moment of your weddings and events, from delicate pieces to large-scale sculptural installations.</p><p>Conceived in perfect harmony with your visual identity, each creation brings elegance and authenticity, placing the botanical at the heart of your reception's emotional experience.</p><p>It is a refined signature, playing on the balance of colours and textures, to give your reception an unforgettable visual dimension.</p>"
  },
  "services.3.title": { fr: 'PAPETERIE', en: 'STATIONERY' },
  "services.3.body": {
    fr: "<p>Avec la prestation Papeterie, nous créons l'identité graphique complète de votre mariage, du logo ou monogramme personnalisé aux faire-part, menus, programmes, marque-places, plans de table et signalétique. À partir d'un moodboard et d'une direction artistique définie avec vous, nous déclinons un univers visuel cohérent sur l'ensemble de vos supports, pour une papeterie sur-mesure, raffinée et parfaitement harmonisée avec l'esthétique et l'ambiance de votre mariage.</p>",
    en: "<p>With the Stationery offering, we create the full graphic identity of your wedding, from custom logo or monogram to invitations, menus, programmes, place cards, seating plans and signage. From a moodboard and a creative direction defined with you, we extend a coherent visual world across all your printed pieces, for bespoke, refined stationery perfectly harmonised with the aesthetic and atmosphere of your wedding.</p>"
  },
