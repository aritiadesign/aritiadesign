...
export const i18n: Record<string, { fr: string; en: string }> = {
  ...
  "investment.tier.0.b7": { fr: "Livrable : carnet PDF<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>croquis<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>plans 2D<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>BAT", en: "Deliverable: PDF booklet<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>sketches<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>2D plans<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>print proofs" },
  ...
  "investment.tier.1.b0": { fr: "Direction artistique commune : planches d'inspiration<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>palette de couleurs<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>palette de matières<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>charte typographique, harmonisant papeterie et décor", en: "Shared creative direction: inspiration boards<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>colour palette<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>material palette<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>typography guidelines, harmonising stationery and decor" },
  "investment.tier.1.b1": { fr: "Papeterie essentielle : faire-part<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>menus<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>plan de table<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>monogramme classique", en: "Essential stationery: invitations<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>menus<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>seating chart<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>classic monogram" },
  ...
  "investment.tier.1.b6": { fr: "Livrable : carnet PDF<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>croquis<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>plans 2D<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>inventaire", en: "Deliverable: PDF booklet<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>sketches<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>2D plans<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>inventory" },
  ...
  "investment.alacarte.1.b0": { fr: "Planche d'inspiration florale", en: "Floral inspiration board" },
  ...
  "investment.alacarte.2.b1": { fr: "Croquis et/ou plan 2D de l'espace principal", en: "Sketches and/or 2D plan of the main space" },
  "investment.alacarte.2.b2": { fr: "Sélection du mobilier et des objets décoratifs", en: "Selection of furniture and decorative objects" },
  "investment.alacarte.2.b3": { fr: "Coordination des prestataires", en: "Supplier coordination" },
  "investment.alacarte.2.b4": { fr: "2 réunions de travail et 1 visite du lieu de réception", en: "2 working meetings and 1 venue visit" },
  "investment.alacarte.2.b5": { fr: "Installation le jour J et démontage J+1", en: "Set-up on the day and dismantling on D+1" },
  "investment.alacarte.2.b6": { fr: "Livrable : carnet PDF<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>croquis<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>plans 2D<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>inventaire", en: "Deliverable: PDF booklet<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>sketches<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>2D plans<span class=\"md:hidden\" aria-hidden=\"true\">, </span><span class=\"hidden md:inline-block font-display font-normal align-middle mx-1.5 opacity-50\" aria-hidden=\"true\">+</span>inventory" },
