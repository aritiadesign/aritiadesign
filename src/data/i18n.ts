...
export const i18n: Record<string, { fr: string; en: string }> = {
  ...
  "investment.disclaimer": {
    fr: "Les tarifs affichés correspondent à notre gamme <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">ESSENTIEL</span>. Les gammes supérieures <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">SIGNATURE</span> et <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">PRESTIGE</span>, comme le reste de nos offres, sont détaillées dans notre <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">Guide des Services</span>. Votre devis est élaboré <span class=\"font-medium not-italic text-[var(--color-ink)]\">sur mesure</span> d'après l'<span class=\"font-medium not-italic text-[var(--color-ink)]\">ampleur du projet</span>, sa <span class=\"font-medium not-italic text-[var(--color-ink)]\">complexité logistique</span> et le <span class=\"font-medium not-italic text-[var(--color-ink)]\">nombre d'invités</span>.",
    en: "The rates shown correspond to our <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">ESSENTIEL</span> range. The higher ranges <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">SIGNATURE</span> and <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">PRESTIGE</span>, as well as the rest of our offers, are detailed in our <span class=\"font-medium not-italic tracking-[0.04em] text-[var(--color-ink)]\">Services Guide</span>. Your quote is crafted <span class=\"font-medium not-italic text-[var(--color-ink)]\">bespoke</span> based on the <span class=\"font-medium not-italic text-[var(--color-ink)]\">project's scale</span>, its <span class=\"font-medium not-italic text-[var(--color-ink)]\">logistical complexity</span> and the <span class=\"font-medium not-italic text-[var(--color-ink)]\">guest count</span>."
  },
